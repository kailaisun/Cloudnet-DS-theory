...
def mybatch_generator_train(zip_list, img_rows, img_cols, batch_size, shuffle=False, max_possible_input_value=255):
...
def mybatch_generator_validation(zip_list, img_rows, img_cols, batch_size, shuffle=False, max_possible_input_value=255):
    number_of_batches = np.ceil(len(zip_list) / batch_size)
    if shuffle:
        random.shuffle(zip_list)
    counter = 0
...
def mybatch_generator_prediction(tstfiles, img_rows, img_cols, batch_size, max_possible_input_value=256):
